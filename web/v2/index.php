                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <?php if($connected){ ?>
                    <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $mail; ?><i class="icon-angle-down"></i>&nbsp;<span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span></a>
        ...
        <div class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">
                    <div class="container">
                      <div class="gap"></div>
                        <div class="row" id="bandeauHome">
                            <div class="col-sm-8 col-xs-12 col-sm-12">

                              <h2 class="boxed animation animated-item-1 fade-down">DON'T FORGET YOUR LIST ANYMORE</h2>
                              <form method="POST" id="contact-form" class="form-horizontal" action="page.php?page=createlist" >
                                  <div class="form-group">
                                      <input type="text" name="tempLabel" id="tempLabel" class="boxed animation animated-item-1 fade-down form-control" placeholder="What is it about..." required/>
                                  </div>
                                  <div class="form-group  col-md-12">
                                    <input class="btn btn-md animation bounce-in" type="submit" name="submit" value="Submit" />
                                  </div>
                              </form>

                            </div>
                            <div class="col-sm-4 hidden-xs hidden-sm" id="">
